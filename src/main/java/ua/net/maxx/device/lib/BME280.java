package ua.net.maxx.device.lib;
...
import ua.net.maxx.device.utils.EndianReaders;
import ua.net.maxx.device.utils.StringUtils;
...
import static ua.net.maxx.device.utils.TimeUtil.delay;
...
public class BME280 {
    ...
    public BME280() throws I2CFactory.UnsupportedBusNumberException {
        this(BME280_I2CADDR, I2CBus.BUS_1);
    }

    public BME280(int address, int i2cbus) throws I2CFactory.UnsupportedBusNumberException {
        try {
            // Get i2c bus
            bus = I2CFactory.getInstance(i2cbus); // Depends onthe RasPi version
            if (verbose) {
