...
public class PinSettings {
    ...
    public static PinSettings fromEvent(PinEvent event) {
		PinMode mode = PinMode.valueOf(event.any().get("mode"));
		PinPullResistance pullUp = PinPullResistance.valueOf(event.any().get("pullUp"));
		return new PinSettings(event.getAddress(), event.getName(), mode, pullUp);
    }
	...
	public String toString() {
		return "PinSettings [address=" + address + ", name=" + name + ", pinMode=" + pinMode + ", pullResistance="
				+ pullResistance + ", pinState=" + pinState + "]";
	}
